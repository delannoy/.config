...
#^+v::{
    ; WIN+CTRL+SHIFT+V: paste public Dropbox link from corresponding file path in clipboard
...
#+!INS::{
    ; WIN+SHIFT+ALT+INS: convert space and [illegal/reserved filename characters](https://learn.microsoft.com/en-us/windows/win32/fileio/naming-a-file) in cliboard to [URL percent encoding](http://www.w3schools.com/tags/ref_urlencode.asp)
    clipboard := A_CLIPBOARD
    clipboard := StrReplace(clipboard, " ", "%20")
